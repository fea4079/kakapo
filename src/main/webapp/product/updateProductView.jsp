...
<body>
	...
	<div class="container">
		...
		<form class="form-horizontal" enctype="multipart/form-data">
			...
			<div class="form-group">
				<label for="price" class="col-sm-offset-1 col-sm-3 control-label">가
					격</label>
				<div class="col-sm-4">
			...
			<div class="form-group">
				...
				<div class="col-sm-4">
					<input type="file" class="form-control" id="uploadFile" name="file"
						value="${product.fileName}"> <img
						src="/images/uploadFiles/${product.fileName}" /> <input
			...
			<div class="form-group">
				<div class="col-sm-offset-4  col-sm-4 text-right">
					...
					<input type="hidden" name="prodNo" value="${product.prodNo}" /> <input
						type="hidden" name="menu" value="${param.menu}" /> <a
						class="btn btn-primary btn" id="cancel" href="#" role="button">취소</a>
				</div>
			</div>
		</form>
