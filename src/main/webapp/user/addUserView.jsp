	...
	<div class="container">
		...
		<form class="form-horizontal">
			...
			<div class="form-group">
				...
				<div class="col-sm-3">
					<button type="button" class="btn btn-info btn-email-auth"
						id="emailAuthBtn">이메일 인증</button>
					<!-- 
			        <button type="button" class="btn btn-info" id="emailAuthBtn">이메일 인증</button> -->
				</div>
			</div>
			<div class="form-group">
				<label for="authCode" class="col-sm-offset-1 col-sm-3 control-label">인증
					코드</label>
				<div class="col-sm-4">
					<input type="text" class="form-control" id="authCode"
						name="authCode" placeholder="이메일로 받은 인증 코드를 입력해주세요">
				</div>
			</div>
			...
			<div class="form-group">
				<div class="col-sm-offset-4  col-sm-4 text-center">
					<button type="button" class="btn btn-primary btn-register">가
						&nbsp;입</button>
					<!-- 
